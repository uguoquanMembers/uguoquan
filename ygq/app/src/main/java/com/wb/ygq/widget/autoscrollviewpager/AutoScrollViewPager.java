...
//        LogUtils.LOGE(TAG + " dispatchTouchEvent slideBorderMode = " + slideBorderMode);
...
//            LogUtils.LOGE(TAG + " dispatchTouchEvent slideBorderMode = " + slideBorderMode + " downY = " + downY + " touchY = " + touchY + " downX = " + downX + " touchX = " + touchX + " currentItem = " + currentItem + " pageCount = " + pageCount);
            /**
            ...
            if ((currentItem == 0 && downX <= touchX) || (currentItem == pageCount - 1 && downX >= touchX)) {
                if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT) {
                    ...
                    if (pageCount > 1) {
//                        LogUtils.LOGE(TAG + " currentItem 符合要求 dispatchTouchEvent 切换currentItem ");
                        setCurrentItem(pageCount - currentItem - 1, isBorderAnimation);
                    }
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
                boolean dtEvent = super.dispatchTouchEvent(ev);
//                LogUtils.LOGE(TAG + " currentItem 符合要求 dispatchTouchEvent super.dispatchTouchEvent.dtEvent = " + dtEvent);
                return dtEvent;
            }
        }
        getParent().requestDisallowInterceptTouchEvent(true);
        boolean event = super.dispatchTouchEvent(ev);
//        LogUtils.LOGE(TAG + " dispatchTouchEvent end super.dispatchTouchEvent = " + event);
        return event;
    }
