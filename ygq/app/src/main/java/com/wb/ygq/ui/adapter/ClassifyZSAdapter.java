 ...
 */
public class ClassifyZSAdapter extends BaseRecyclerAdapter<VideoFMBean.DataBean.VideoListBean> {
    public ClassifyZSAdapter(Context context) {
        super(context);
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ClassifyBjHolder(LayoutInflater.from(mContext).inflate(R.layout.item_classify_zs, null));
    }
