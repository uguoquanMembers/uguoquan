...
public abstract class RecyclingPagerAdapter extends PagerAdapter
{
	...
	RecyclingPagerAdapter(@NonNull RecycleBin recycleBin)
	{
	...
	@Override
	public final void destroyItem(@NonNull ViewGroup container, int position, Object object)
	{
	...
	/**
	 * <p> Returns the number of types of Views that will be created by
	 * {@link #getView}. Each type represents a set of views that can be converted
	 * in {@link #getView}. If the adapter always returns the same type of View
	 * for all items, this method should return 1. </p> <p> This method will only
	 * be called when when the adapter is set on the the {@link AdapterView}. </p>
	 *
	 ...
	 *
	 * @param position
	 *          The position of the item within the adapter's data set whose view
	 *          type we want.
	 ...
	 *          data, this method can create a new view. Heterogeneous lists can
	 *          specify their number of view types, so that this View is always of
	 *          the right type (see {@link #getViewTypeCount()} and
